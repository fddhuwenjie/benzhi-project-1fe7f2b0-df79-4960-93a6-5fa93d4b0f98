...
func (s *Service) mutate(ctx context.Context, batchID, action string, meta CommandMeta, input any, status int, fn mutation) (Result, error) {
	...
	snap, err := s.repo.LoadContext(ctx, batchID)
	if err != nil {
		return Result{}, err
	}
...
func (s *Service) RegisterItem(batchID string, meta CommandMeta, in RegisterItem) (Result, error) {
	return s.mutate(context.Background(), batchID, "item.registered", meta, in, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) RegisterItems(batchID string, meta CommandMeta, in RegisterItems) (Result, error) {
	return s.mutate(context.Background(), batchID, "items.batch_registered", meta, in, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) FreezeBaseline(batchID string, meta CommandMeta) (Result, error) {
	return s.mutate(context.Background(), batchID, "baseline.frozen", meta, struct{}{}, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) SubmitTreatmentRound(batchID string, meta CommandMeta, in SubmitRound) (Result, error) {
	return s.SubmitTreatmentRoundContext(context.Background(), batchID, meta, in)
}

func (s *Service) SubmitTreatmentRoundContext(ctx context.Context, batchID string, meta CommandMeta, in SubmitRound) (Result, error) {
	return s.mutate(ctx, batchID, "round.submitted", meta, in, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) RecordCorrection(batchID string, meta CommandMeta, in RecordCorrection) (Result, error) {
	return s.mutate(context.Background(), batchID, "correction.recorded", meta, in, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) RecordCorrections(batchID string, meta CommandMeta, in RecordCorrections) (Result, error) {
	return s.mutate(context.Background(), batchID, "corrections.batch_recorded", meta, in, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) StartReview(batchID string, meta CommandMeta, in StartReview) (Result, error) {
	return s.mutate(context.Background(), batchID, "review.started", meta, in, 201, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) SubmitReview(batchID string, meta CommandMeta, in SubmitReview) (Result, error) {
	return s.mutate(context.Background(), batchID, "review.signed", meta, in, 200, func(b *domain.TreatmentBatch, _ *store.Snapshot) (string, any, json.RawMessage, error) {
...
func (s *Service) Decide(batchID string, meta CommandMeta, in FinalDecision) (Result, error) {
	return s.mutate(context.Background(), batchID, "batch.sealed", meta, in, 200, func(b *domain.TreatmentBatch, snap *store.Snapshot) (string, any, json.RawMessage, error) {
